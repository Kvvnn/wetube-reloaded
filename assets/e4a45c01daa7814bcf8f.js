...
var createFFmpegCore = function () {
  ...
  return function (createFFmpegCore) {
    ...
    var ma = !1,
        ...
        l = !1,
        pa = !1;
    ma = "object" === (typeof window === "undefined" ? "undefined" : _typeof(window));
    oa = "function" === typeof importScripts;
    l = "object" === (typeof process === "undefined" ? "undefined" : _typeof(process)) && "object" === _typeof(process.versions) && "string" === typeof process.versions.node;
    pa = !ma && !l && !oa;

    var _n = f.ENVIRONMENT_IS_PTHREAD || !1;
    ...
    if (l) {
    ...
    } else if (pa) "undefined" != typeof read && (ta = function ta(a) {
      return read(a);
    }), va = function va(a) {
      ...
      return a;
    }, "undefined" != typeof scriptArgs ? ja = scriptArgs : "undefined" != typeof arguments && (ja = arguments), "function" === typeof quit && (la = function la(a) {
      quit(a);
    }), "undefined" !== typeof print && ("undefined" === typeof console && (console = {}), console.log = print, console.warn = console.error = "undefined" !== typeof printErr ? printErr : print);else if (ma || oa) oa ? ra = self.location.href : "undefined" !== typeof document && document.currentScript && (ra = document.currentScript.src), _scriptDir && (ra = _scriptDir), 0 !== ra.indexOf("blob:") ? ra = ra.substr(0, ra.lastIndexOf("/") + 1) : ra = "", l ? (ta = function ta(a, b) {
      wa || (wa = require("fs"));
      xa || (xa = require("path"));
      a = xa.normalize(a);
      return wa.readFileSync(a, b ? null : "utf8");
    ...
    "object" !== (typeof WebAssembly === "undefined" ? "undefined" : _typeof(WebAssembly)) && u("no native wasm support detected");
    var Ca,
        Da,
        threadInfoStruct = 0,
        selfThreadId = 0,
    ...
    if (_n) Ca = f.wasmMemory, qa = f.buffer;else if (f.wasmMemory) Ca = f.wasmMemory;else if (Ca = new WebAssembly.Memory({
      initial: Va / 65536,
      maximum: Va / 65536,
      shared: !0
    ...
    function gb() {
      assert(!_n, "addRunDependency cannot be used in a pthread worker");
      cb++;
    ...
    function u(a) {
      ...
      _n && console.error("Pthread aborting at " + Error().stack);
      h(a);
      Ea = !0;
    ...
    function vb(a, b) {
      ...
      var c = Atomics.load(D, _L.Vf >> 2),
          d = 0;
      if (c == a && Atomics.compareExchange(D, _L.Vf >> 2, c, 0) == c && (--b, d = 1, 0 >= b)) return 1;
    ...
    function wb(a) {
      if (_n) throw "Internal Error! cancelThread() can only ever be called from main application thread!";
      if (!a) throw "Internal Error! Null pthread_ptr in cancelThread!";

      _L.Ef[a].worker.postMessage({
        cmd: "cancel"
      });
    }

    function xb(a) {
      if (_n) throw "Internal Error! cleanupThread() can only ever be called from main application thread!";
      if (!a) throw "Internal Error! Null pthread_ptr in cleanupThread!";
      D[a + 12 >> 2] = 0;
      (a = _L.Ef[a]) && _L.Ag(a.worker);
    }
    ...
    var _L = {
      ...
      pi: function pi() {
        ...
        Atomics.store(E, _L.xf + 104 >> 2, b);
        Atomics.store(E, _L.xf + 40 >> 2, _L.xf);
        Atomics.store(E, _L.xf + 44 >> 2, 42);
      ...
      ri: function ri() {
        ...
        aa(f);
        _L.receiveObjectTransfer = _L.Ii;
        _L.setThreadStatus = _L.Li;
        _L.threadCancel = _L.Pi;
        _L.threadExit = _L.Qi;
      },
      Ch: function Ch() {
        _L.Vf = zb;
      ...
      eh: function eh() {
        ...
        _n && threadInfoStruct && Ab();
      },
      Qi: function Qi(a) {
        var b = rb | 0;
        b && (Atomics.store(E, b + 4 >> 2, a), Atomics.store(E, b + 0 >> 2, 1), Atomics.store(E, b + 60 >> 2, 1), Atomics.store(E, b + 64 >> 2, 0), _L.eh(), vb(b + 0, 2147483647), ub(0, 0, 0), threadInfoStruct = 0, _n && postMessage({
          cmd: "exit"
        }));
      },
      Pi: function Pi() {
      ...
      Oi: function Oi() {
        for (var a in _L.Ef) {
          var b = _L.Ef[a];
          b && b.worker && _L.Ag(b.worker);
        }

        _L.Ef = {};

        for (a = 0; a < _L.Gf.length; ++a) {
          var c = _L.Gf[a];
          c.terminate();
        }
        ...
        for (a = 0; a < _L.Kf.length; ++a) {
          c = _L.Kf[a], b = c.yf, _L.Pg(b), c.terminate();
        }
      ...
      Ag: function Ag(a) {
        delete _L.Ef[a.yf.Lh];

        _L.Gf.push(a);

        _L.Kf.splice(_L.Kf.indexOf(a), 1);
      ...
      vi: function vi(a, b) {
        a.onmessage = function (c) {
          var d = c.data,
              e = d.cmd;
          a.yf && (_L.Mg = a.yf.threadInfoStruct);
          ...
          if (d.targetThread && d.targetThread != (rb | 0)) {
          ...
          } else if ("processQueuedMainThreadWork" === e) Cb();else if ("spawnThread" === e) Db(c.data);else if ("cleanupThread" === e) xb(d.thread);else if ("killThread" === e) {
            c = d.thread;
            if (_n) throw "Internal Error! killThread() can only ever be called from main application thread!";
            ...
            _L.Kf.splice(_L.Kf.indexOf(c.worker), 1);

            c.worker.yf = void 0;
          } else if ("cancelThread" === e) wb(d.thread);else if ("loaded" === e) a.loaded = !0, b && b(a), a.og && (a.og(), delete a.og);else if ("print" === e) ea("Thread " + d.threadId + ": " + d.text);else if ("printErr" === e) h("Thread " + d.threadId + ": " + d.text);else if ("alert" === e) alert("Thread " + d.threadId + ": " + d.text);else if ("exit" === e) a.yf && Atomics.load(E, a.yf.Lh + 68 >> 2) && _L.Ag(a);else if ("exitProcess" === e) {
            noExitRuntime = !1;
          ...
          } else "cancelDone" === e ? _L.Ag(a) : "objectTransfer" !== e && ("setimmediate" === c.data.target ? a.postMessage(c.data) : h("worker sent an unknown command " + e));
      ...
      Vh: function Vh() {
        ...
        _L.Gf.push(new Worker(a));
      },
      li: function li() {
        0 == _L.Gf.length && (_L.Vh(), _L.vi(_L.Gf[0]));
        return 0 < _L.Gf.length ? _L.Gf.pop() : null;
      },
      Zi: function Zi(a) {
    ...
    } : "undefined" !== typeof dateNow ? Eb = dateNow : Eb = function Eb() {
    ...
    function Hb(a, b) {
      if (0 === a) a = Date.now();else if (1 === a || 4 === a) a = Eb();else return Fb(28), -1;
      D[b >> 2] = a / 1E3 | 0;
      D[b + 4 >> 2] = a % 1E3 * 1E6 | 0;
      return 0;
    }
    ...
    function Kb() {
      ...
      if (!Kb.Yh) {
        ...
        c = Na(c);
        d = Na(d);
        e < b ? (D[Nb() >> 2] = c, D[Nb() + 4 >> 2] = d) : (D[Nb() >> 2] = d, D[Nb() + 4 >> 2] = c);
      }
    }
    ...
    var Zb = {
        ...
        if (!a.input.length) {
          ...
          if (l) {
            ...
            try {
              ...
              if (-1 != e.toString().indexOf("EOF")) d = 0;else throw e;
            }
      ...
      Zg: function Zg(a, b) {
        null === b || 10 === b ? (ea(Ja(a.output, 0)), a.output = []) : 0 != b && a.output.push(b);
      },
      flush: function flush(a) {
        a.output && 0 < a.output.length && (ea(Ja(a.output, 0)), a.output = []);
      }
    },
        ec = {
      Zg: function Zg(a, b) {
        null === b || 10 === b ? (h(Ja(a.output, 0)), a.output = []) : 0 != b && a.output.push(b);
      },
      flush: function flush(a) {
        a.output && 0 < a.output.length && (h(Ja(a.output, 0)), a.output = []);
      }
    },
        O = {
      Df: null,
      ...
      createNode: function createNode(a, b, c, d) {
        ...
        N.kf(c.mode) ? (c.cf = O.Df.dir.node, c.df = O.Df.dir.stream, c.bf = {}) : N.isFile(c.mode) ? (c.cf = O.Df.file.node, c.df = O.Df.file.stream, c.gf = 0, c.bf = null) : N.Mf(c.mode) ? (c.cf = O.Df.link.node, c.df = O.Df.link.stream) : N.hg(c.mode) && (c.cf = O.Df.lh.node, c.df = O.Df.lh.stream);
      ...
      Ji: function Ji(a, b) {
        if (a.gf != b) if (0 == b) a.bf = null, a.gf = 0;else {
          if (!a.bf || a.bf.subarray) {
            var c = a.bf;
            a.bf = new Uint8Array(b);
            c && a.bf.set(c.subarray(0, Math.min(b, a.gf)));
          } else if (a.bf || (a.bf = []), a.bf.length > b) a.bf.length = b;else for (; a.bf.length < b;) {
            a.bf.push(0);
          }
      ...
      df: {
        ...
        write: function write(a, b, c, d, e, g) {
          ...
          O.sh(a, e + d);
          if (a.bf.subarray && b.subarray) a.bf.set(b.subarray(c, c + d), e);else for (g = 0; g < d; g++) {
            a.bf[e + g] = b[c + g];
          }
          a.gf = Math.max(a.gf, e + d);
          return d;
        },
        tf: function tf(a, b, c) {
      ...
      ff: function ff(a, b) {
        ...
        for (d = 0; d < a.length; d++) {
          ...
          if (!g || b.wf) for (g = 0; N.Mf(e.mode);) {
            if (e = N.readlink(c), c = Vb(Rb(c), e), e = N.ff(c, {
              ah: b.ah
            }).node, 40 < g++) throw new N.af(32);
          }
        }
      ...
      If: function If(a) {
        for (var b;;) {
          if (N.wg(a)) return a = a.jf.Eh, b ? "/" !== a[a.length - 1] ? a + "/" + b : a + b : a;
          b = b ? a.name + "/" + b : a.name;
          a = a.parent;
        }
      },
      ...
      Ah: function Ah(a) {
        var b = N.Sg(a.parent.id, a.name);
        if (N.Cf[b] === a) N.Cf[b] = a.Pf;else for (b = N.Cf[b]; b;) {
          if (b.Pf === a) {
            b.Pf = a.Pf;
            break;
          }
      ...
      isFIFO: function isFIFO(a) {
        return 4096 === (a & 61440);
      },
      isSocket: function isSocket(a) {
      ...
      nh: function nh(a, b, c) {
        N.Hg || (N.Hg = function () {}, N.Hg.prototype = {
          object: {
            get: function get() {
              return this.node;
            },
      ...
      lstat: function lstat(a) {
        return N.stat(a, !0);
      },
      chmod: function chmod(a, b, c) {
        var d;
      ...
      lchmod: function lchmod(a, b) {
        N.chmod(a, b, !0);
      },
      fchmod: function fchmod(a, b) {
        a = N.zf(a);
        if (!a) throw new N.af(8);
        N.chmod(a.node, b);
      },
      chown: function chown(a, b, c, d) {
        var e;
      ...
      lchown: function lchown(a, b, c) {
        N.chown(a, b, c, !0);
      },
      fchown: function fchown(a, b, c) {
        a = N.zf(a);
        if (!a) throw new N.af(8);
        N.chown(a.node, b, c);
      },
      truncate: function truncate(a, b) {
        if (0 > b) throw new N.af(28);
        var c;
      ...
      open: function open(a, b, c, d, e) {
        if ("" === a) throw new N.af(44);
        b = "string" === typeof b ? N.Dh(b) : b;
        c = b & 64 ? ("undefined" === typeof c ? 438 : c) & 4095 | 32768 : 0;
        if ("object" === _typeof(a)) var g = a;else {
          a = Qb(a);
        ...
        !f.logReadFiles || b & 1 || (N.$g || (N.$g = {}), a in N.$g || (N.$g[a] = 1, h("FS.trackingDelegate error on read file: " + a)));

        try {
          N.mf.onOpenFile && (e = 0, 1 !== (b & 2097155) && (e |= N.Mh.Gh.Rh), 0 !== (b & 2097155) && (e |= N.Mh.Gh.Sh), N.mf.onOpenFile(a, e));
        } catch (m) {
      ...
      read: function read(a, b, c, d, e) {
        ...
        if (!g) e = a.position;else if (!a.seekable) throw new N.af(70);
      ...
      write: function write(a, b, c, d, e, g) {
        ...
        if (!k) e = a.position;else if (!a.seekable) throw new N.af(70);
      ...
      Wf: function Wf(a, b, c, d, e, g) {
        if (0 !== (e & 2) && 0 === (g & 2) && 2 !== (a.flags & 2097155)) throw new N.af(2);
      ...
      readFile: function readFile(a, b) {
        b = b || {};
        b.flags = b.flags || "r";
      ...
      writeFile: function writeFile(a, b, c) {
        c = c || {};
        c.flags = c.flags || "w";
        ...
        } else if (ArrayBuffer.isView(b)) N.write(a, b, 0, b.byteLength, void 0, c.Zh);else throw Error("Unsupported data type");
      ...
      rh: function rh() {
        ...
        }, N.af.prototype = Error(), N.af.prototype.constructor = N.af, [44].forEach(function (a) {
          N.Qg[a] = new N.af(a);
      ...
      Lg: function Lg(a, b) {
        ...
        try {
          c = N.ff(a, {
            parent: !0
          }), d.Ci = !0, d.Ei = c.path, d.Di = c.node, d.name = Sb(a), c = N.ff(a, {
            wf: !b
      ...
      bj: function bj(a, b, c, d, e) {
        ...
        g.prototype.kh = function () {
          ...
          x.Wh(function (z) {
            ...
            if ("undefined" === typeof x.Sf[z]) {
              var fb = x.Sf;
              if (I > V) throw Error("invalid range (" + I + ", " + V + ") or no bytes requested!");
              if (V > t - 1) throw Error("only " + t + " bytes available! programmer error!");
          ...
          if (q || !t) p = t = 1, p = t = this.yh(0).length, ea("LazyFiles on gzip forces download of the whole file when length is accessed");
          this.Uh = t;
          this.Th = p;
          this.Vg = !0;
        };
        ...
        if ("undefined" !== typeof XMLHttpRequest) {
          if (!oa) throw "Cannot do synchronous binary XHRs outside webworkers in modern browsers. Use --embed-file or --preload-file in emcc";
          var k = new g();
      ...
      dj: function dj(a, b, c, d, e, g, k, m, r, q) {
        function t(B) {
          function p(z) {
            q && q();
            m || N.mh(a, b, z, d, e, r);
    ...
    function ic(a, b, c) {
      ...
      D[c + 28 >> 2] = d.rdev;
      D[c + 32 >> 2] = 0;
      J = [d.size >>> 0, (H = d.size, 1 <= +Math.abs(H) ? 0 < H ? (Math.min(+Math.floor(H / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((H - +(~~H >>> 0)) / 4294967296) >>> 0 : 0)];
      D[c + 40 >> 2] = J[0];
      D[c + 44 >> 2] = J[1];
      D[c + 48 >> 2] = 4096;
      D[c + 52 >> 2] = d.blocks;
      ...
      D[c + 76 >> 2] = 0;
      J = [d.ino >>> 0, (H = d.ino, 1 <= +Math.abs(H) ? 0 < H ? (Math.min(+Math.floor(H / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((H - +(~~H >>> 0)) / 4294967296) >>> 0 : 0)];
      D[c + 80 >> 2] = J[0];
      D[c + 84 >> 2] = J[1];
      return 0;
    }
      ...
      try {
        ...
        for (var g = b ? D[b >> 2] : 0, k = b ? D[b + 4 >> 2] : 0, m = c ? D[c >> 2] : 0, r = c ? D[c + 4 >> 2] : 0, q = d ? D[d >> 2] : 0, t = d ? D[d + 4 >> 2] : 0, w = 0, B = 0, p = 0, x = 0, z = 0, I = 0, V = (b ? D[b >> 2] : 0) | (c ? D[c >> 2] : 0) | (d ? D[d >> 2] : 0), fb = (b ? D[b + 4 >> 2] : 0) | (c ? D[c + 4 >> 2] : 0) | (d ? D[d + 4 >> 2] : 0), K = 0; K < a; K++) {
          ...
          if (32 > K ? V & X : fb & X) {
            ...
            na & 1 && (32 > K ? g & X : k & X) && (32 > K ? w |= X : B |= X, e++);
            na & 4 && (32 > K ? m & X : r & X) && (32 > K ? p |= X : x |= X, e++);
            na & 2 && (32 > K ? q & X : t & X) && (32 > K ? z |= X : I |= X, e++);
          }
        }
    ...
    function mc(a, b) {
      ...
      try {
        ...
        if (b & -8) var c = -28;else {
          ...
          (d = N.ff(a, {
            wf: !0
          }).node) ? (a = "", b & 4 && (a += "r"), b & 2 && (a += "w"), b & 1 && (a += "x"), c = a && N.Jf(d, a) ? -2 : 0) : c = -44;
        }
        return c;
      } catch (e) {
    ...
    function pc(a, b, c) {
      ...
      try {
        ...
        for (var e = N.tf(d, 0, 1), g = Math.floor(e / 280); g < d.Lf.length && a + 280 <= c;) {
          ...
          J = [m >>> 0, (H = m, 1 <= +Math.abs(H) ? 0 < H ? (Math.min(+Math.floor(H / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((H - +(~~H >>> 0)) / 4294967296) >>> 0 : 0)];
          D[b + a >> 2] = J[0];
          D[b + a + 4 >> 2] = J[1];
          J = [280 * (g + 1) >>> 0, (H = 280 * (g + 1), 1 <= +Math.abs(H) ? 0 < H ? (Math.min(+Math.floor(H / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((H - +(~~H >>> 0)) / 4294967296) >>> 0 : 0)];
          D[b + a + 8 >> 2] = J[0];
          D[b + a + 12 >> 2] = J[1];
          Sa[b + a + 16 >> 1] = 280;
          v[b + a + 18 >> 0] = r;
    ...
    function qc(a, b) {
      if (_n) return M(8, 1, a, b);

      try {
        return rc(b, 0, 136), D[b >> 2] = 1, D[b + 4 >> 2] = 2, D[b + 8 >> 2] = 3, D[b + 12 >> 2] = 4, 0;
      } catch (c) {
    ...
    function uc(a, b) {
      if (_n) return M(11, 1, a, b);

      try {
        return a = A(a), a = Qb(a), "/" === a[a.length - 1] && (a = a.substr(0, a.length - 1)), N.mkdir(a, b, 0), 0;
      } catch (c) {
        return "undefined" !== typeof N && c instanceof N.af || u(c), -c.ef;
      }
    }
    ...
    function vc(a, b, c, d, e, g) {
      if (_n) return M(12, 1, a, b, c, d, e, g);

      try {
        a: {
          g <<= 12;
          var k = !1;
          if (0 !== (d & 16) && 0 !== a % 16384) var m = -28;else {
            if (0 !== (d & 32)) {
              var r = wc(16384, b);
    ...
    function Ac(a, b, c, d) {
      if (_n) return M(16, 1, a, b, c, d);

      try {
        return d && (D[d >> 2] = -1, D[d + 4 >> 2] = -1, D[d + 8 >> 2] = -1, D[d + 12 >> 2] = -1), 0;
      } catch (e) {
        return "undefined" !== typeof N && e instanceof N.af || u(e), -e.ef;
      }
    }
    ...
    var Q = {
      jf: function jf() {
        f.websocket = f.websocket && "object" === _typeof(f.websocket) ? f.websocket : {};
        f.websocket.Ig = {};
      ...
      createSocket: function createSocket(a, b, c) {
        b &= -526337;
        c && assert(1 == b == (6 == c));
        a = {
          family: a,
      ...
      qf: {
        tg: function tg(a, b, c) {
          ...
          if (d) {
            if (d._socket) b = d._socket.remoteAddress, c = d._socket.remotePort;else {
              c = /ws[s]?:\/\/([^:]+):(\d+)/.exec(d.url);
            ...
            var e = f.websocket && "object" === _typeof(f.websocket),
                g = "ws:#".replace("#", "//");
            ...
            var m = void 0;
            "null" !== k && (k = k.replace(/^ +| +$/g, "").split(/ *, */), m = l ? {
              protocol: k.toString()
            } : k);
        ...
        ni: function ni(a, b) {
          ...
          function d(g) {
            if ("string" === typeof g) g = new TextEncoder().encode(g);else {
            ...
            var k = e;
            e = !1;
            k && 10 === g.length && 255 === g[0] && 255 === g[1] && 255 === g[2] && 255 === g[3] && 112 === g[4] && 111 === g[5] && 114 === g[6] && 116 === g[7] ? (g = g[8] << 8 | g[9], Q.qf.Hh(a, b), b.port = g, Q.qf.jh(a, b)) : (a.ag.push({
              hf: b.hf,
              port: b.port,
              data: g
          ...
          var e = !0;
          l ? (b.socket.on("open", c), b.socket.on("message", function (g, k) {
        ...
        Zf: function Zf(a) {
          ...
          if (a.ag.length || !c || c && c.socket.readyState === c.socket.CLOSING || c && c.socket.readyState === c.socket.CLOSED) b |= 65;
        ...
        Uf: function Uf(a, b, c) {
          switch (b) {
            case 21531:
              return b = 0, a.ag.length && (b = a.ag[0].data.length), D[c >> 2] = b, 0;
        ...
        bind: function bind(a, b, c) {
          if ("undefined" !== typeof a.Bg || "undefined" !== typeof a.Qf) throw new N.af(28);
          a.Bg = b;
          a.Qf = c;
        ...
        fh: function fh(a, b, c, d, e, g) {
          ...
          if (1 === a.type) {
            if (!k || k.socket.readyState === k.socket.CLOSING || k.socket.readyState === k.socket.CLOSED) throw new N.af(53);
          ...
          if (2 === a.type && (!k || k.socket.readyState !== k.socket.OPEN)) return k && k.socket.readyState !== k.socket.CLOSING && k.socket.readyState !== k.socket.CLOSED || (k = Q.qf.tg(a, e, g)), k.ug.push(m), d;
    ...
    function Kc(a) {
      ...
      b = Fc(a);
      if (null !== b) return a;
      Ic[a] ? b = Ic[a] : (b = Hc++, assert(65535 > b, "exceeded max address mappings of 65535"), b = "172.29." + (b & 255) + "." + (b & 65280), Jc[b] = a, Ic[a] = b);
      return b;
    }
    ...
    function Nc(a) {
      ...
      for (c = 0; 8 > c; c++) {
        0 === a[c] && (1 < c - e && (k = 0), e = c, k++), k > d && (d = k, g = c - d + 1);
      }

      for (c = 0; 8 > c; c++) {
        1 < d && 0 === a[c] && c >= g && c < g + d ? c === g && (b += ":", 0 === g && (b += ":")) : (b += Number(Oc(a[c] & 65535)).toString(16), b += 7 > c ? ":" : "");
      }
    ...
    function Rc(a, b) {
      ...
      try {
        ...
        switch (a) {
          ...
          case 6:
            return k = b(), q = P(), P(), Qc(q, k.family, Kc(k.Bg || "0.0.0.0"), k.Qf), 0;
          ...
          case 15:
            ...
            var V = P(),
                ...
                K = P(),
                X = P();
            return 1 === V && 4 === fb ? (D[K >> 2] = k.error, D[X >> 2] = 4, k.error = null, 0) : -50;
          ...
          case 17:
            ...
            for (W = 0; 0 < dc && W < na; W++) {
              if (bc = D[ha + 8 * W >> 2], cc = D[ha + (8 * W + 4) >> 2]) B = Math.min(cc, dc), x = I.buffer.subarray(k, k + B), Ka.set(x, bc + k), k += B, dc -= B;
            }
    ...
    function Vc() {
      l || oa || (za || (za = {}), za["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] || (za["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] = 1, h("Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread")));
    }
    ...
    function Wc(a, b, c) {
      ...
      if (ma) {
        ...
        for (Atomics.exchange(D, _L.Vf >> 2, a);;) {
          d = performance.now();
          if (d > c) return Atomics.exchange(D, _L.Vf >> 2, 0), -73;
          d = Atomics.exchange(D, _L.Vf >> 2, 0);
          if (0 == d) break;
          Cb();
          if (Atomics.load(D, a >> 2) != b) return -6;
          Atomics.exchange(D, _L.Vf >> 2, a);
        }
    ...
    function sd(a, b, c, d, e, g, k, m) {
      b = R[b];
      if (a = U[a](b, c)) d = m && Ia(a.name, m, d), e && (D[e >> 2] = d), g && (D[g >> 2] = a.size), k && (D[k >> 2] = a.type);
    }
    ...
    function ud(a, b, c) {
      if (b) {
        ...
        if (void 0 === d) switch (e = U.getParameter(a), _typeof(e)) {
          case "number":
            d = e;
            break;
          ...
          default:
            T(1280);
            h("GL_INVALID_ENUM in glGet" + c + "v: Native code calling glGet" + c + "v(" + a + ") and it returns " + e + " of type " + _typeof(e) + "!");
            return;
        }
    ...
    function wd(a, b, c, d) {
      if (c) {
        if (a = U.getUniform(R[a], S[b]), "number" == typeof a || "boolean" == typeof a) switch (d) {
          case 0:
            D[c >> 2] = a;
            break;
    ...
    function xd(a, b, c, d) {
      if (c) {
        if (a = U.getVertexAttrib(a, b), 34975 == b) D[c >> 2] = a && a.name;else if ("number" == typeof a || "boolean" == typeof a) switch (d) {
          case 0:
            D[c >> 2] = a;
            break;
    ...
    function Gd(a, b, c) {
      ...
      if (d.Fh || !d.aj) d.Fh && (d = d.Fh), a = !1, d.rg && d.rg.qg && (a = d.rg.qg.getParameter(2978), a = 0 === a[0] && 0 === a[1] && a[2] === d.width && a[3] === d.height), d.width = b, d.height = c, a && d.rg.qg.viewport(0, 0, b, c);else {
        if (d.sg) {
          a = a ? A(a) : "";
          d = D[d.sg + 8 >> 2];
          var e = y(),
    ...
    function Id(a, b, c) {
      return _n ? M(23, 1, a, b, c) : Gd(a, b, c);
    }
    ...
    function Qd(a, b, c, d, e) {
      ...
      try {
        ...
        N.tf(g, a, d);
        J = [g.position >>> 0, (H = g.position, 1 <= +Math.abs(H) ? 0 < H ? (Math.min(+Math.floor(H / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((H - +(~~H >>> 0)) / 4294967296) >>> 0 : 0)];
        D[e >> 2] = J[0];
        D[e + 4 >> 2] = J[1];
    ...
    function Td(a) {
      Td.buffer || (Td.buffer = Oa(256), Sd["0"] = "Success", Sd["-1"] = "Invalid value for 'ai_flags' field", Sd["-2"] = "NAME or SERVICE is unknown", Sd["-3"] = "Temporary failure in name resolution", Sd["-4"] = "Non-recoverable failure in name res", Sd["-6"] = "'ai_family' not supported", Sd["-7"] = "'ai_socktype' not supported", Sd["-8"] = "SERVICE not supported for 'ai_socktype'", Sd["-10"] = "Memory allocation failure", Sd["-11"] = "System error returned in 'errno'", Sd["-12"] = "Argument buffer overflow");
      var b = "Unknown error";
    ...
    function Ud(a, b, c, d) {
      ...
      var g = 0,
          ...
          q = 0,
          t = 0;
      c && (m = D[c >> 2], r = D[c + 4 >> 2], q = D[c + 8 >> 2], t = D[c + 12 >> 2]);
      q && !t && (t = 2 === q ? 17 : 6);
      !q && t && (q = 17 === t ? 2 : 1);
      0 === t && (t = 6);
      0 === q && (q = 1);
      ...
      if (b && (b = A(b), k = parseInt(b, 10), isNaN(k))) return m & 1024 ? -2 : -8;
      if (!a) return 0 === r && (r = 2), 0 === (m & 1) && (2 === r ? g = Vd(2130706433) : g = [0, 0, 0, 1]), a = e(r, q, t, null, g, k), D[d >> 2] = a, 0;
      a = A(a);
      g = Ec(a);
      if (null !== g) {
        if (0 === r || 2 === r) r = 2;else if (10 === r && m & 8) g = [0, 0, Vd(65535), g], r = 10;else return -2;
      } else if (g = Fc(a), null !== g) if (0 === r || 10 === r) r = 10;else return -2;
    ...
    function Db(a) {
      if (_n) throw "Internal Error! spawnThread() can only ever be called from main application thread!";
    ...
    function Yd(a, b) {
      ...
      if (_n && selfThreadId == a) return h("PThread " + a + " is attempting to join to itself!"), 16;
      if (!_n && _L.xf == a) return h("Main thread " + a + " is attempting to join to itself!"), 16;
      if (D[a + 12 >> 2] !== a) return h("pthread_join attempted on thread " + a + ", which does not point to a valid thread, or does not exist anymore!"), 71;
      if (Atomics.load(E, a + 68 >> 2)) return h("Attempted to join thread " + a + ", which was already detached!"), 28;

      for (Vc();;) {
        var c = Atomics.load(E, a >> 2);
        if (1 == c) return c = Atomics.load(E, a + 4 >> 2), b && (D[b >> 2] = c), Atomics.store(E, a + 68 >> 2, 1), _n ? postMessage({
          cmd: "cleanupThread",
          thread: a
        }) : xb(a), 0;
        if (_n && threadInfoStruct && !Atomics.load(E, threadInfoStruct + 60 >> 2) && 2 == Atomics.load(E, threadInfoStruct + 0 >> 2)) throw "Canceled!";
        _n || Cb();
        Wc(a, c, _n ? 100 : 1);
      }
    }
    ...
    function de(a) {
      ...
      switch (a) {
        ...
        case 84:
          return "object" === (typeof navigator === "undefined" ? "undefined" : _typeof(navigator)) ? navigator.hardwareConcurrency || 1 : 1;
      }
    ...
    var Ge = {
      c: function c(a, b, _c, d) {
        u("Assertion failed: " + A(a) + ", at: " + [b ? A(b) : "unknown filename", _c, d ? A(d) : "unknown function"]);
      },
      K: function K(a, b) {
        a = ne(a, b);
      ...
      pa: function pa(a, b) {
        ...
        });else if (_n) postMessage({
          targetThread: a,
          cmd: "processThreadQueue"
        });else {
          a = (a = _L.Ef[a]) && a.worker;
          if (!a) return;
          a.postMessage({
            cmd: "processThreadQueue"
          });
      ...
      ld: function ld(a, b, c, d) {
        U.colorMask(!!a, !!b, !!c, !!d);
      },
      kd: function kd(a) {
        U.compileShader(_ed[a]);
      },
      jd: function jd(a, b, c, d, e, g, k, m) {
        U.compressedTexImage2D(a, b, c, d, e, g, m ? Ka.subarray(m, m + k) : null);
      },
      id: function id(a, b, c, d, e, g, k, m, r) {
        U.compressedTexSubImage2D(a, b, c, d, e, g, k, r ? Ka.subarray(r, r + m) : null);
      },
      hd: function hd(a, b, c, d, e, g, k, m) {
        U.copyTexImage2D(a, b, c, d, e, g, k, m);
      },
      gd: function gd(a, b, c, d, e, g, k, m) {
      ...
      bd: function bd(a, b) {
        for (var c = 0; c < a; ++c) {
          var d = D[b + 4 * c >> 2],
              e = _bd[d];
          e && (U.deleteFramebuffer(e), e.name = 0, _bd[d] = null);
        }
      },
      ad: function ad(a) {
        if (a) {
          var b = R[a];
          b ? (U.deleteProgram(b), b.name = 0, R[a] = null, hd[a] = null) : T(1281);
        }
      },
      ga: function ga(a, b) {
        for (var c = 0; c < a; c++) {
      ...
      _c: function _c(a) {
        if (a) {
          var b = _ed[a];
          b ? (U.deleteShader(b), _ed[a] = null) : T(1281);
        }
      },
      Zc: function Zc(a, b) {
        for (var c = 0; c < a; c++) {
      ...
      Ec: function Ec(a, b, c, d, e, g, k) {
        sd("getActiveAttrib", a, b, c, d, e, g, k);
      },
      Dc: function Dc(a, b, c, d, e, g, k) {
      ...
      uc: function uc(a, b, c) {
        if (c) {
          if (a >= $c) T(1281);else {
            var d = hd[a];
            if (d) {
              if (35716 == b) a = U.getProgramInfoLog(R[a]), null === a && (a = "(unknown error)"), D[c >> 2] = a.length + 1;else if (35719 == b) D[c >> 2] = d.Xg;else if (35722 == b) {
                if (-1 == d.jg) {
                  a = R[a];
                ...
                if (-1 == d.kg) for (a = R[a], e = U.getProgramParameter(a, 35382), b = d.kg = 0; b < e; ++b) {
      ...
      qc: function qc(a, b, c, d) {
        a = U.getShaderInfoLog(_ed[a]);
        null === a && (a = "(unknown error)");
        b = 0 < b && d ? Ia(a, d, b) : 0;
        c && (D[c >> 2] = b);
      },
      pc: function pc(a, b, c, d) {
        a = U.getShaderPrecisionFormat(a, b);
        D[c >> 2] = a.rangeMin;
        D[c + 4 >> 2] = a.rangeMax;
        D[d >> 2] = a.precision;
      },
      oc: function oc(a, b, c, d) {
        if (a = U.getShaderSource(_ed[a])) b = 0 < b && d ? Ia(a, d, b) : 0, c && (D[c >> 2] = b);
      },
      rc: function rc(a, b, c) {
        c ? 35716 == b ? (a = U.getShaderInfoLog(_ed[a]), null === a && (a = "(unknown error)"), D[c >> 2] = a ? a.length + 1 : 0) : 35720 == b ? (a = U.getShaderSource(_ed[a]), D[c >> 2] = a ? a.length + 1 : 0) : D[c >> 2] = U.getShaderParameter(_ed[a], b) : T(1281);
      },
      nc: function nc(a) {
        if (id[a]) return id[a];
      ...
      bc: function bc(a) {
        return (a = _bd[a]) ? U.isFramebuffer(a) : 0;
      },
      ac: function ac(a) {
        ...
        for (var c = a.Nh, d = U.getProgramParameter(b, 35718), e = 0; e < d; ++e) {
          ...
          if (m) {
            ...
            for (var q = 1; q < g.size; ++q) {
              m = U.getUniformLocation(b, k + "[" + q + "]"), r = ld(S), S[r] = m;
            }
          }
        }
      },
      ...
      Hb: function Hb(a, b, c, d, e, g, k, m, r) {
      ...
      Cb: function Cb(a, b, c, d, e, g, k, m, r) {
        var q = null;
        r && (q = yd(m, k, e, g, r));
      ...
      Ab: function Ab(a, b, c) {
        if (288 >= b) for (var d = zd[b - 1], e = 0; e < b; ++e) {
          d[e] = F[c + 4 * e >> 2];
      ...
      yb: function yb(a, b, c) {
        if (288 >= b) for (var d = Ad[b - 1], e = 0; e < b; ++e) {
          d[e] = D[c + 4 * e >> 2];
      ...
      wb: function wb(a, b, c) {
        if (144 >= b) for (var d = zd[2 * b - 1], e = 0; e < 2 * b; e += 2) {
      ...
      ub: function ub(a, b, c) {
        if (144 >= b) for (var d = Ad[2 * b - 1], e = 0; e < 2 * b; e += 2) {
      ...
      sb: function sb(a, b, c) {
        if (96 >= b) for (var d = zd[3 * b - 1], e = 0; e < 3 * b; e += 3) {
      ...
      qb: function qb(a, b, c) {
        if (96 >= b) for (var d = Ad[3 * b - 1], e = 0; e < 3 * b; e += 3) {
      ...
      mb: function mb(a, b, c) {
        if (72 >= b) for (var d = Ad[4 * b - 1], e = 0; e < 4 * b; e += 4) {
          d[e] = D[c + 4 * e >> 2], d[e + 1] = D[c + (4 * e + 4) >> 2], d[e + 2] = D[c + (4 * e + 8) >> 2], d[e + 3] = D[c + (4 * e + 12) >> 2];
        } else d = D.subarray(c >> 2, c + 16 * b >> 2);
        U.uniform4iv(S[a], d);
      },
      lb: function lb(a, b, c, d) {
        if (72 >= b) for (var e = zd[4 * b - 1], g = 0; g < 4 * b; g += 4) {
          e[g] = F[d + 4 * g >> 2], e[g + 1] = F[d + (4 * g + 4) >> 2], e[g + 2] = F[d + (4 * g + 8) >> 2], e[g + 3] = F[d + (4 * g + 12) >> 2];
        } else e = F.subarray(d >> 2, d + 16 * b >> 2);
        U.uniformMatrix2fv(S[a], !!c, e);
      },
      kb: function kb(a, b, c, d) {
        if (32 >= b) for (var e = zd[9 * b - 1], g = 0; g < 9 * b; g += 9) {
          e[g] = F[d + 4 * g >> 2], e[g + 1] = F[d + (4 * g + 4) >> 2], e[g + 2] = F[d + (4 * g + 8) >> 2], e[g + 3] = F[d + (4 * g + 12) >> 2], e[g + 4] = F[d + (4 * g + 16) >> 2], e[g + 5] = F[d + (4 * g + 20) >> 2], e[g + 6] = F[d + (4 * g + 24) >> 2], e[g + 7] = F[d + (4 * g + 28) >> 2], e[g + 8] = F[d + (4 * g + 32) >> 2];
      ...
      oa: function oa(a, b) {
        ...
        c.vj = D[b + 13];
        a = Fd(a);
        if (!a || c.hi) c = 0;else if (a = a.getContext("webgl", c)) {
          b = Oa(8);
          D[b + 4 >> 2] = rb | 0;
          var d = {
            jj: b,
      ...
      T: function T(a) {
        ...
        var b = new Date(D[a + 20 >> 2] + 1900, D[a + 16 >> 2], D[a + 12 >> 2], D[a + 8 >> 2], D[a + 4 >> 2], D[a >> 2], 0),
            ...
            m = Math.min(k, g);
        0 > c ? D[a + 32 >> 2] = Number(g != k && m == d) : 0 < c != (m == d) && (g = Math.max(k, g), b.setTime(b.getTime() + 6E4 * ((0 < c ? m : g) - d)));
        D[a + 24 >> 2] = b.getDay();
        D[a + 28 >> 2] = (b.getTime() - e.getTime()) / 864E5 | 0;
        return b.getTime() / 1E3 | 0;
      },
      Ra: function Ra(a) {
        if (a === _L.Ph) return h("Main thread (id=" + a + ") cannot be canceled!"), 71;
        if (!a) return h("pthread_cancel attempted on a null thread pointer!"), 71;
        if (D[a + 12 >> 2] !== a) return h("pthread_cancel attempted on thread " + a + ", which does not point to a valid thread, or does not exist anymore!"), 71;
      ...
      n: function n(a, b, c, d) {
        if ("undefined" === typeof SharedArrayBuffer) return h("Current environment does not support SharedArrayBuffer, pthreads are not available!"), 6;
        if (!a) return h("pthread_create called with a null thread pointer!"), 28;
        var e = [];
        if (_n && 0 === e.length) return Fe(687865856, a, b, c, d);
        var g = 0,
            k = 0,
            m = 0,
            r = 0;
        ...
        if (b) {
          ...
          if (0 === D[b + 16 >> 2]) {
            ...
            m = b + 20;
            r = b + 24;
            var B = _L.Mg ? _L.Mg : rb | 0;
            if (m || r) if (B) {
              if (D[B + 12 >> 2] !== B) h("pthread_getschedparam attempted on thread " + B + ", which does not point to a valid thread, or does not exist anymore!");else {
        ...
        _n ? (c.$i = "spawnThread", postMessage(c, e)) : Db(c);
        return 0;
      },
      o: function o(a, b) {
        return Yd(a, b);
      ...
      m: function m(a, b, c, d) {
        ...
        var w = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),
            _B = "January February March April May June July August September October November December".split(" ");
    ...
    f.setValue = function (a, b, c) {
      ...
      switch (c) {
        ...
        case "i64":
          J = [b >>> 0, (H = b, 1 <= +Math.abs(H) ? 0 < H ? (Math.min(+Math.floor(H / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((H - +(~~H >>> 0)) / 4294967296) >>> 0 : 0)];
          D[a >> 2] = J[0];
          D[a + 4 >> 2] = J[1];
          break;
    ...
    function Me(a) {
      ...
      if (!(0 < cb)) {
        ...
        0 < cb || (f.setStatus ? (f.setStatus("Running..."), setTimeout(function () {
          setTimeout(function () {
            f.setStatus("");
          }, 1);
          b();
...
if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object') module.exports = createFFmpegCore;else if (typeof define === 'function' && define['amd']) define([], function () {
  return createFFmpegCore;
});else if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object') exports["createFFmpegCore"] = createFFmpegCore;